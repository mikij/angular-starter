...
@Component({
  ...
  template: `
    <div class="flex items-center border-b px-3" cmdk-input-wrapper="">
      <div
        class="icon-search mr-2 flex h-4 w-4 shrink-0 items-center justify-center opacity-50"></div>
      <input
        #searchInput
        [class]="classes()"
  ...
  implements ControlValueAccessor, OnInit, OnDestroy
{
  ...
  private readonly jsonCommandComponent = inject(ZardCommandJsonComponent, {
    optional: true,
  });
