    ...
    <span
      ...
      <main class="relative flex">
        <input
          ...
          name="checkbox" />
        <i
          class="icon-check text-primary-foreground pointer-events-none absolute top-1/2 left-1/2 flex -translate-x-1/2 -translate-y-1/2 items-center justify-center opacity-0 peer-checked:opacity-100"></i>
      </main>
