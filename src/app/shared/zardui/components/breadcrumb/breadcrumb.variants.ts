...
export type ZardBreadcrumbListVariants = VariantProps<
...
export type ZardBreadcrumbLinkVariants = VariantProps<
...
export type ZardBreadcrumbPageVariants = VariantProps<
...
export type ZardBreadcrumbSeparatorVariants = VariantProps<
...
export type ZardBreadcrumbEllipsisVariants = VariantProps<
  typeof breadcrumbEllipsisVariants
>;
