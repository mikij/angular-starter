...
export function isTemplateRef<T>(
  value: TemplateRef<T> | unknown
): value is TemplateRef<T> {
...
export class ZardStringTemplateOutletDirective<_T = unknown>
  ...
  ngOnChanges(changes: SimpleChanges): void {
    ...
    const shouldRecreateView = (): boolean => {
      ...
      const shouldContextRecreate =
        zStringTemplateOutletContext &&
        hasContextShapeChanged(zStringTemplateOutletContext);
