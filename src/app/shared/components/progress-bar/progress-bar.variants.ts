...
export const containerProgressBarVariants = cva('w-full transition-all', {
  variants: {
    zType: {
      ...
      destructive:
        'bg-primary-foreground dark:text-secondary-foreground hover:bg-destructive/10',
...
export type ZardContainerProgressBarVariants = VariantProps<
  typeof containerProgressBarVariants
>;
