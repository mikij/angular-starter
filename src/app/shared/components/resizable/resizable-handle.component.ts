...
export class ZardResizableHandleComponent {
  ...
  private adjustSizes(delta: number): void {
    ...
    const leftMin = this.resizable.convertToPercentage(
      leftPanel.zMin() || 0,
      containerSize
    );
    const leftMax = this.resizable.convertToPercentage(
      leftPanel.zMax() || 100,
      containerSize
    );
    const rightMin = this.resizable.convertToPercentage(
      rightPanel.zMin() || 0,
      containerSize
    );
    const rightMax = this.resizable.convertToPercentage(
      rightPanel.zMax() || 100,
      containerSize
    );
